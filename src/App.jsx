...
export default function PortfolioApp() {
  ...
  return (
    <div className={dark ? "dark" : ""}>
      <div className={`min-h-screen ${dark ? "bg-[#0b0b10] text-slate-200" : "bg-white text-slate-800"}`}>
        <Preloader />
        ...
        <footer className="border-t border-white/10 py-10 mt-10">
          <div className="mx-auto max-w-6xl px-4 flex flex-col items-center gap-4 md:flex-row md:justify-between">
            <p className="text-sm text-slate-400">© {new Date().getFullYear()} {ME.name}. All rights reserved.</p>
